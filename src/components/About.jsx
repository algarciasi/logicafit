...
export default function Conoceme() {
  return (
    <div className="bg-white">
      {/* 
        Para SEO: Si usas react-helmet, aquí iría:
        <Helmet>
          <title>Conóceme | Entrenador personal</title>
          <meta name="description" content="Llevo más de 20 años entrenando. Descubre mi historia, mi formación y mi forma de entender el entrenamiento personal y la nutrición deportiva." />
        </Helmet>
      */}

      {/* SECCIÓN 1: HERO (Texto Izquierda, Foto Derecha) */}
      <section className="mx-auto max-w-7xl px-6 py-16 sm:py-24 lg:py-32">
        <div className="grid grid-cols-1 gap-16 lg:grid-cols-2 lg:items-center">
          ...
          <figure className="relative">
            {/* PLACEHOLDER: Sustituir src por foto principal natural entrenando/gimnasio */}
            <div className="aspect-[4/5] w-full overflow-hidden rounded-sm bg-slate-100">
              <img
                src="/ruta-a-tu-foto-principal.jpg"
                alt="Alberto, entrenador personal, en el gimnasio"
      ...
      {/* SECCIÓN 2: MI HISTORIA (Foto Izquierda, Texto Derecha) */}
      <section className="mx-auto max-w-7xl px-6 py-16 sm:py-24">
        <div className="grid grid-cols-1 gap-16 lg:grid-cols-2 lg:items-center">
          <figure className="order-2 lg:order-1">
            {/* PLACEHOLDER: Sustituir src por foto histórica antigua tuya entrenando (opcional) */}
            <div className="aspect-square w-full max-w-md overflow-hidden rounded-sm bg-slate-100 lg:max-w-none">
              <img
                src="/ruta-a-tu-foto-antigua.jpg"
                alt="Mis inicios entrenando"
                className="h-full w-full object-cover"
              />
            </div>
            <figcaption className="mt-3 text-sm italic text-slate-500">
              Una de tantas etapas por las que he pasado entrenando.
            </figcaption>
          </figure>
      ...
      {/* SECCIÓN 3: YO TAMBIÉN TENGO ENTRENADOR (Editorial a 1 columna centrada o alineada) */}
      <section className="bg-slate-50 py-16 sm:py-24">
        <div className="mx-auto max-w-3xl px-6">
          ...
          {/* PLACEHOLDER: Foto revisando planificación o entrenando actualmente */}
      ...
      {/* SECCIÓN 4 & 5: POR QUÉ FORMARME + FORMACIÓN OFICIAL */}
      <section className="mx-auto max-w-3xl px-6 py-16 sm:py-24">
        ...
        <div className="mt-16 border-t border-slate-100 pt-12">
          ...
          <div className="mt-8">
            <p className="font-semibold tracking-wide text-navy uppercase text-xs mb-6">
              APTA Vital Sport
            </p>
            <ul className="space-y-5 border-l-2 border-slate-100 pl-6 text-base text-slate-700">
              <li>Entrenamiento Personal de Alto Rendimiento y Técnicas Avanzadas de Musculación</li>
              <li>Máster en Nutrición Deportiva de Alto Rendimiento y Dietética Avanzada</li>
              <li>Máster en Suplementación Deportiva</li>
              <li>Formación específica en entrenamiento cardiovascular y resistencia</li>
            </ul>
          </div>
        </div>
      </section>
      ...
      {/* SECCIÓN 7: FILOSOFÍA DE TRABAJO (Bloque editorial tipográfico) */}
      <section className="mx-auto max-w-5xl px-6 py-16 sm:py-24">
        ...
        <div className="mt-16 grid gap-12 sm:grid-cols-2">
          ...
          <div className="border-t-2 border-slate-900 pt-6">
            <p className="text-xl font-medium leading-relaxed text-navy">
              No cambio ejercicios para mantenerte entretenido. Cambio lo que se necesita cambiar.
            </p>
          </div>
          
          <div className="border-t-2 border-slate-900 pt-6">
            <p className="text-xl font-medium leading-relaxed text-navy">
              Prefiero que entiendas por qué hacemos algo a que simplemente obedezcas.
            </p>
          </div>
          
          <div className="border-t-2 border-slate-900 pt-6">
            <p className="text-xl font-medium leading-relaxed text-navy">
              Y si algo no funciona, se ajusta. No es tu culpa.
            </p>
          </div>
        </div>
      </section>
