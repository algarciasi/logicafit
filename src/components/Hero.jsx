...
export default function Hero() {
  return (
    <section className="relative h-screen min-h-[750px] w-full overflow-hidden bg-navy flex flex-col justify-end pb-12 sm:pb-16 lg:pb-20">
      
      {/* 1. Imagen de Fondo a Pantalla Completa */}
      <img
        src="/brand/alberto-gym.jpg"
        alt="Alberto García, entrenador personal Lógica Fit"
        className="absolute inset-0 h-full w-full object-cover object-[center_20%] opacity-80 animate-fade-in"
      />
      ...
      <div className="relative z-10 mx-auto w-full max-w-7xl px-6 lg:px-8">
        ...
        {/* TITULAR GIGANTE */}
        <h1 className="font-display text-6xl font-extrabold leading-[1.05] text-white tracking-tight sm:text-7xl lg:text-[5.5rem] animate-fade-in-up">
          Entrenador<br />
          Personal<br />
        </h1>
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-12 gap-6 items-end">
          ...
          <div className="md:col-span-6 lg:col-span-5 bg-surface rounded-[2rem] p-8 sm:p-10 shadow-2xl animate-fade-in-up delay-200">
            <p className="text-xs font-bold uppercase tracking-[0.2em] text-text-secondary mb-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link
                to="/planes"
                className="w-full rounded-full bg-orange px-6 py-4 text-center text-sm font-bold text-white shadow-lg transition-all hover:bg-orange-dark hover:scale-105"
              >
                Ver planes
              </Link>
              <Link
                to="/demo"
                className="w-full rounded-full px-6 py-4 text-center text-sm font-bold text-navy ring-1 ring-slate-200 transition-all hover:bg-surface-soft hover:ring-slate-300"
              >
                Ver mi app
              </Link>
            </div>

            {/* Micro-credenciales integradas en la caja */}
          ...
          <div className="md:col-span-6 md:col-start-7 lg:col-span-4 lg:col-start-9 bg-[#0e7490]/90 backdrop-blur-md rounded-3xl p-6 sm:p-8 shadow-2xl border border-cyan-400/20 animate-fade-in-up delay-400">
