...
export default function Hero() {
  return (
    <section className="relative overflow-hidden bg-navy">
      {/* MOBILE: imagen independiente / DESKTOP: fondo */}
      <div className="relative h-[48vh] min-h-[340px] w-full sm:absolute sm:inset-0 sm:h-full sm:min-h-0">
        <img
          ...
          fetchPriority="high"
          className="h-full w-full object-cover object-[70%_25%] sm:object-[68%_18%]"
        />
        ...
        <div className="mx-auto w-full max-w-7xl">
          <div className="max-w-[760px]">
            ...
            <h1 className="mt-5 font-display text-[3.25rem] font-extrabold leading-[0.95] tracking-[-0.045em] text-white sm:text-6xl lg:text-[5.3rem]">
              Entrena con lógica.
              <br />
              <span className="text-white/75">Progresa de verdad.</span>
            </h1>
            ...
            <div className="mt-9 flex flex-col gap-3 sm:flex-row sm:items-center">
              <Link
                to="/planes"
                className="inline-flex min-h-14 items-center justify-center rounded-full bg-orange px-8 text-sm font-bold text-white transition duration-300 hover:-translate-y-0.5 hover:bg-orange-dark"
              >
                Quiero empezar
              </Link>
            ...
            <div className="mt-10 flex flex-wrap items-center gap-x-8 gap-y-4 border-t border-white/15 pt-7">
              <div>
                ...
                <p className="mt-1 text-sm text-slate-300">entrenando y aprendiendo</p>
              </div>
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-slate-300">seguimiento conmigo</p>
              </div>
            </div>
          </div>
        </div>
