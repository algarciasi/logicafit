...
export default function Hero() {
  return (
    <section className="relative w-full overflow-hidden bg-navy flex flex-col sm:h-screen sm:min-h-[750px] sm:justify-end sm:pb-16 lg:pb-20">
      {/* BLOQUE DE IMAGEN
          Móvil: bloque normal de altura fija arriba, la foto se ve entera.
      ...
      <div className="relative h-[48vh] min-h-[320px] w-full sm:absolute sm:inset-0 sm:h-full sm:min-h-0">
        <img
          ...
          className="h-full w-full object-cover object-[50%_30%] sm:object-[center_20%] opacity-90 sm:opacity-80 animate-fade-in"
        />
        {/* Degradado superior: solo móvil, asegura contraste del logo/navbar
            pase lo que pase con la foto debajo */}
        <div className="absolute inset-x-0 top-0 h-24 bg-gradient-to-b from-navy/80 to-transparent sm:hidden" />
          ...
          <div className="mt-8 sm:mt-12 grid grid-cols-1 md:grid-cols-12 gap-4 sm:gap-6 items-end">
            ...
            <div className="md:col-span-6 md:col-start-7 lg:col-span-4 lg:col-start-9 bg-[#0e7490]/90 backdrop-blur-md rounded-2xl sm:rounded-3xl p-5 sm:p-8 shadow-2xl border border-cyan-400/20 animate-fade-in-up delay-400">
              <p className="text-sm text-cyan-50 font-medium leading-relaxed">
                Con un Entrenador Personal Online tendrás todos los beneficios
                de un entrenador presencial, pero con la flexibilidad de poder
                hacerlo todo a distancia gracias a la App Lógica Fit.
              </p>
            </div>
          </div>
        </div>
