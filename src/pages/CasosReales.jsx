...
export default function CasosReales() {
  return (
    <div className="bg-surface overflow-hidden">
      ...
      <section className="relative w-full pt-32 pb-24 bg-navy border-b-[12px] border-orange flex flex-col items-center">
        ...
        <div className="relative z-20 mx-auto max-w-4xl px-6 text-center animate-fade-in-up delay-200">
          ...
          <p className="mx-auto mt-8 text-lg sm:text-xl text-slate-300 font-medium leading-relaxed max-w-2xl">
            No vendo transformaciones mágicas de 30 días porque no son reales.
            Esto es entrenamiento, constancia y un plan lógico adaptado a tu día
            a día.
          </p>
        </div>
      </section>
      ...
      {/* 2. RESEÑAS DE GOOGLE */}
      <section className="mx-auto mt-24 max-w-7xl px-6 pb-24 sm:pb-32 lg:px-8">
        <div className="mb-16 flex flex-col items-center justify-center gap-4">
          ...
          <a
            ...
            className="text-sm font-bold text-text-secondary hover:text-navy transition-colors border-b border-transparent hover:border-navy pb-0.5 mt-2"
          >
            {googleStats.totalReviews === 1
              ? "Leer la reseña en Google →"
              : `Leer las ${googleStats.totalReviews} reseñas en Google →`}
          </a>
        </div>
        ...
        {googleReviews.length > 0 && (
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
            {googleReviews.map((review) => (
              <div
                key={review.id}
                className="flex flex-col justify-between bg-surface-soft p-8 rounded-[2rem] border border-slate-100 shadow-sm hover:shadow-md transition-shadow"
              >
                <div>
      ...
      <section className="bg-navy">
        <div className="mx-auto grid max-w-7xl lg:grid-cols-12">
          ...
          <div className="relative min-h-[420px] lg:col-span-5 lg:min-h-[560px]">
            ...
            {/* Integración de la fotografía con el fondo */}
            <div className="absolute inset-0 bg-gradient-to-t from-navy/45 to-transparent lg:bg-gradient-to-r lg:from-transparent lg:to-navy/35" />
          </div>
          ...
          <div className="flex items-center px-6 py-20 sm:px-10 lg:col-span-7 lg:px-16 lg:py-24">
            <div className="max-w-xl">
              ...
              <h2 className="mt-5 font-display text-4xl font-extrabold leading-[1.04] tracking-[-0.035em] text-white sm:text-5xl">
                Los resultados empiezan
                <br />
                por hacer las cosas bien.
              </h2>

              <p className="mt-6 text-lg leading-8 text-slate-300">
                Si has llegado hasta aquí, probablemente ya sabes qué quieres
                cambiar. Cuéntame dónde estás ahora, qué quieres conseguir y
                veremos si puedo ayudarte a llegar hasta allí.
              </p>

              <p className="mt-4 text-sm leading-6 text-slate-400">
                Te responderé yo personalmente y te diré con total sinceridad
                qué opción tendría sentido en tu caso.
              </p>

              <a
                href="https://wa.me/34678951544?text=Hola!%20He%20visto%20los%20casos%20reales%20de%20L%C3%B3gica%20Fit%20y%20me%20gustar%C3%ADa%20contarte%20mi%20caso"
                target="_blank"
                rel="noopener noreferrer"
