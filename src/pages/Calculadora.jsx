    ...
    <div className="bg-surface-soft min-h-screen py-16 px-6 lg:px-8">
      ...
      <div className="mx-auto max-w-[1000px] bg-white rounded-[2rem] shadow-2xl shadow-slate-200/50 overflow-hidden animate-fade-in-up">
        ...
        <div className="p-8 sm:p-12 lg:p-14">
          ...
          <h1 className="font-display text-4xl font-extrabold text-navy tracking-tight sm:text-5xl">
            Calcula tus macros diarios
          </h1>
          
          <p className="mt-4 text-sm text-text-secondary font-medium max-w-2xl leading-relaxed">
